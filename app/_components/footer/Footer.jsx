...
const Footer = () => {
  return (
    <div className='bg-white md:pt-5 pt-5 md:pb-5 md:mt-10 mt-5 border-t-2 border-slate-200 pb-5 md:sticky md:bottom-0 z-50'>
      <section className='flex md:flex-row flex-col md:space-x-4 space-y-3 md:space-y-0 justify-between md:w-4/5 mx-auto text-center items-center '>
        ...
        <Link href='https://t.me/Edu_Vix' className='md:text-2xl text-lg font-bold text-slate-600'><TelegramIcon /> Telegram</Link>
        <Link href='/' className='md:text-2xl text-lg font-bold text-slate-600'><YouTubeIcon /> YouTube</Link>
