...
const data = [
  {
    ...
    icon: <AddTaskIcon fontSize='large' className='text-sky-600 animate__animated animate__zoomIn animate__delay-1s'/>
  },
  {
    ...
    icon: <QueryBuilderIcon fontSize='large' className='text-sky-600 animate__animated animate__zoomIn animate__delay-2s'/>
  },
  {
    title: "Qo'llab quvvatlash",
    description: "Telegram chatbotimiz sizga butun kun mobaynida savollaringizga javob beradi.",
    icon: <SupportAgentIcon fontSize='large' className='text-sky-600 animate__animated animate__zoomIn animate__delay-3s'/>
  },
  {
    title: "Bo'lib to'lash imkoniyati",
    description: "Har bir kurs to'lovlarini modullarga bo'lgan holda to'lab borishingiz mumkin.",
    icon: <AttachMoneyIcon fontSize='large' className='text-sky-600 animate__animated animate__zoomIn animate__delay-4s'/>
  },
]
